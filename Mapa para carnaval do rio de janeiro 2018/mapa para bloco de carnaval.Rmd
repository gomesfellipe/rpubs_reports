...
<!-- Descricao: Carnaval esta começando e muita gente quer saber: "Onde tem bloco??" Para ajudar a responder essa pergunta e orientar os foliões hoje vou mostrar como podemos obter referencias geograficas a partir de endereços e criar mapas interativos usando R!   -->
...
d1 <- DT::datatable(base,options = list(
