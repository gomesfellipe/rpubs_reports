...
Traduzido com meu inglês de índio:

"Essencialmente, todos os modelos estão errados, mas alguns são úteis" - George E. P. Box

Se você estuda estatística provavelmente já deve saber quem é este simpático senhor. Box teve grande contribuição para a estatística, foi aluno do Ronald Aylmer Fisher e não satisfeito se casou com a filha dele!
...
Para o bom ajuste de um modelo, certamente; a inferência, as análises de desvios, os crtérios de seleção de um modelo, conferir comportamento dos resíduos e avaliação das estatísticas de diagnósticos são muito relevantes.
...
Este pacote é sensacional, existem funções muito relevantes nele para melhorar a nossa experiência com ajuste de modelos, as funções apresentadas aqui baseadas na [página de documentação GGally](http://ggobi.github.io/ggally/#ggally), lá você pode conferir a documentação completa.
...
Além disso, você pode usar nomes de colunas para essas propriedades, vamos separar os grupos de machos e femeas por cores:
