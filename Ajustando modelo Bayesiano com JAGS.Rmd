---
title: "Implementando modelos bayesianos"
...
![Imagem da Internet](https://365datascience.com/wp-content/uploads/2017/08/Lindleys_paradox_Bayes_theorem-min.png)
...
Para isso devemos utilizamos **toda** informação disponível, seja ela **objetiva** ou **subjetiva** (isto é, vinda de umam amostra ou de algum conhecimento préveo ou intuitivo)
...
caterplot(bayes.mod.fit.mcmc,parms = params) #Observando as estimativas de todos os parâmetros sem o desvio
...
Para diagnósticos rápidos, pode produzir arquivos html com traço, densidade e autocorrelação. 
...
#Uma função muito conveniente para analisar representações numéricas de diagnósticos em uma varredura é o pacote de superdiag (Tsai, Gill e Rapkin, 2012).
library(superdiag)
superdiag(bayes.mod.fit.mcmc, burnin = 100)
```

```{r}
#Atualizando o modelo, se necessário - por exemplo, se não houver convergência ou pouca convergencia:
